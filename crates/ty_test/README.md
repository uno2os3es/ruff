...
_only_, you can filter the tests using `mdtest__`:
...
> the section above for more details. The feature outlined below, _inline_ diagnostic snapshotting,
> is still desirable.
...
[^extensions]:
    `typing-extensions` is a third-party module, but typeshed, and thus type checkers

...
In (regular) source files, annotations are _not_ deferred. This also tests that imports from
...
If `__future__.annotations` is imported, annotations _are_ deferred.

...
And if _any_ parameters use the new PEP-570 convention, the old convention does not apply:
...
protocol. This is matched against any of the _unmatched_ standard (positional or keyword),

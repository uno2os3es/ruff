...
classes _cannot_ generally be used in multiple inheritance with other builtin types. This is because
...
attribute on the other type _but_ the type of the attribute on the other type is disjoint from the

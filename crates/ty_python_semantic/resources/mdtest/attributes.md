...
If the _metaclass_ attribute is only partially defined, we emit a `possibly-missing-attribute`
diagnostic:
...
gradual guarantee, because the unknown decorator _could_ be an alias for `builtins.classmethod`.

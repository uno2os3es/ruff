...
types describe the set of values that _can_ be truthy (`bool(t)` can return `True`) or falsy
...
of values that can be truthy _and_ falsy. This intersection is not empty. In the following, we give
